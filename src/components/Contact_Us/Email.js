...
const Email =()=>{
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_i7gnobg', 'template_selw9ig', form.current, 'AFqehjYq5uzNkvPod')
          .then(
            (result) => {
...
<Container className="contactform_img" >
      <Row>
        <Col sm={6}>
  ...
  <div class="contact">
    <div class="left">
      ...
      <div class="form">
        ...
        <div class="field">
          <input type="text" name="phone_num" id="phone" required/>
          <label for="phone" class="label">Your Mobile Number</label>
        </div>

        <div class="field">
          <input type="text" name="subject" id="phone" required/>
          <label for="phone" class="label">Subject</label>
        </div>

        <div class="field">
          <textarea name="Message" id="msg" cols="30" rows="5" required></textarea>
          <label for="msg" class="label t_msg">Your Message</label>
        </div>
        {/* <button  type="submit" className="btn_form"> ارسال</button> */}
        <button type="submit" class="btn1">Submit <div></div> </button>
      </div>
    ...
    <div class="right">
      <div class="right_heading">
        <img src={logocontact} className="logocontact"></img>
      </div>
      <div class="tabs">
        <div class="tab1 tab">
  ...
  <div class="social">
    <a href="https://twitter.com/handlingpr28790" target="_blank" class="twitter">
    ...
    <a href="https://www.facebook.com/profile.php?id=100090016143151" target="_blank" class="facebook">
